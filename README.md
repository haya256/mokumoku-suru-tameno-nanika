...
荒らし対策として、特定の人だけ他の参加者を強制退出させられるようにできます。
...
- 入室・チャットなどでいつもの合言葉を聞かれたとき、**代わりにこの管理者合言葉を入力**すると、通常の書き込み権限に加えて「強制退出」権限も得られます（専用のログイン画面はありません）
...
- 参加者に配る合言葉とは別物にしてください。同じにすると全員が強制退出できてしまいます
